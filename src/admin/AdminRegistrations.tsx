...
// import { calculateAllocation } from '@/UI/conventionAllocation'
...
//     useState(settings.studyGroupCount)

//   const [rooms, setRooms] =
//     useState(settings.accommodationCount)
...
//       /*
//        * Importing updateDoc directly here
//        * so we can update all registrations.
//        */
...
//       toast.success(
//         'Study groups and accommodation fixed successfully'
//       )
//     } catch (error) {
//       console.error(error)

//       toast.error(
//         'Failed to fix allocation'
//       )
//     }
//   }
...
//           View convention registrations and
//           automatically organize participants.
//         </p>
//       </div>
...
//           Set the number of study groups and
//           accommodation rooms. The system will
//           automatically distribute registered
//           participants.
//         </p>
...
//           className="mt-6 bg-[#008080] hover:bg-[#006666] text-white px-6 py-3 rounded-xl font-bold transition"
//         >
//           Fix Study Groups & Accommodation
//         </button>
